...
<template>
  <UPage>
    <UPageHeader title="Privacy Policy" description="Last updated: March 2026" />
    <UPageBody>
      <UPageSection>
        <div class="prose dark:prose-invert max-w-none">
          <h3>1. Introduction</h3>
          <p>Welcome to Rahul Dhole's portfolio and blog. We respect your privacy and are committed to protecting your
          ...
          <ul>
            <li><strong>Technical Data</strong> includes internet protocol (IP) address, your login data, browser type
              ...
              platform, and other technology on the devices you use to access this website.</li>
          ...
          <p>Third party vendors, including Google, use cookies to serve ads based on your prior visits to this website
            or other websites.</p>
          <p>Google's use of advertising cookies enables it and its partners to serve ads to you based on your visit to
          ...
          <p>This website may include links to third-party websites, plug-ins and applications. Clicking on those links
            or enabling those connections may allow third parties to collect or share data about you.</p>

          <h3>5. Contact Us</h3>
          <p>If you have any questions about this privacy policy or our privacy practices, please contact us at <a
              href="mailto:mail@rahuldhole.com">mail@rahuldhole.com</a>.</p>
        </div>
      </UPageSection>
    </UPageBody>
  </UPage>
