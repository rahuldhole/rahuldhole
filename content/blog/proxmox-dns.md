...
- While using LXC when everything looks good but still your network is not reachable then check the serially last network added in the LXC because the last LXC's gateway is taken into consideration for routing `ip r`. :br**Soltuions**
